...
datay, datayerr = MF.GenerateDataVectorVis(data)

#print (firstguess)


# # curve fit the test data
#fitparams, cavmat = curve_fit(MF.ModelFitBinVis, data, datay, p0=firstguess, sigma=datayerr, bounds=(boundsmin, boundsmax))
res = minimize(MF.ModelChi2BinVis, firstguess, args=data, method=method) #, bounds=bounds, tol=1e-6)
